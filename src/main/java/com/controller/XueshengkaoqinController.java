...
public class XueshengkaoqinController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengkaoqinEntity xueshengkaoqin,
		...
		if(tableName.equals("jiaoshi")) {
			xueshengkaoqin.setGonghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R xingmingkaoqinzhuangkuangTypeStat(HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = xueshengkaoqinService.xingmingkaoqinzhuangkuangTypeStat(params, ew);
        return R.ok().put("data", result);
    }
    ...
    public R count(@RequestParam Map<String, Object> params,XueshengkaoqinEntity xueshengkaoqin, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
            xueshengkaoqin.setXuehao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<XueshengkaoqinEntity> ew = new EntityWrapper<XueshengkaoqinEntity>();
        int count = xueshengkaoqinService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xueshengkaoqin), params), params));
