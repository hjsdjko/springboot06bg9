...
public interface KechengxinxiService extends IService<KechengxinxiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<KechengxinxiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<KechengxinxiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<KechengxinxiEntity> wrapper);
