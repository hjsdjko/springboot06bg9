...
public class KechengchengjiServiceImpl extends ServiceImpl<KechengchengjiDao, KechengchengjiEntity> implements KechengchengjiService {
    ...
    @Override
    public List<Map<String, Object>> fenshuSectionStat(Map<String, Object> params, Wrapper<KechengchengjiEntity> wrapper) {
        return baseMapper.fenshuSectionStat(params, wrapper);
    }
